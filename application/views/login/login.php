...
<div class="d-flex justify-content-center align-items-center login-container">
        ...
        <form method="post" action="<?php echo base_url()?>Login" class="login-form text-center">
            <?php echo $this->session->flashdata('pesan') ?>
            <?php echo $this->session->flashdata('berhasil') ?>
            <h1 class="mb-3 font-weight-normal text-uppercase">Login</h1>
            ...
            <button type="submit" name = "login" class="btn mt-3 rounded-pill btn-lg btn-custom btn-block text-uppercase">Login</button>
